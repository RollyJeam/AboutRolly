...
import rollyPic from './images/Rolly.png'
    ...
    <div className="flex-all">
      ...
      <div className="container">
        ...
        <div className="profile-image">
          <img src={rollyPic} alt="Rolly Jeam A. Abletes" />
        </div>
        <p><strong>Mailing Address:</strong></p>
        <p>Purok 5, Brgy. R.M. Tan</p>
        <p>Ormoc City, Leyte, Philippines</p>
        <p><strong>Cell:</strong> 09270352913</p>
        <p><strong>Mail:</strong> <a href="mailto:rollyac2015@gmail.com">rollyac2015@gmail.com</a></p>

        <ToggleSection title="CAREER VISION"><div className='vision'><p>{resumeData.careerVision}</p></div></ToggleSection>
